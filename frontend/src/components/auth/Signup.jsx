...
const Signup = () => {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-[#fdf2f8] text-black">
      <div className="w-96 p-6 bg-white shadow-lg border border-gray-300 rounded-lg text-center">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="relative">
              <input
                ...
                className="w-4/5 p-2.5 pl-10 border border-black rounded-xl text-sm"
            ...
            <button className="w-full py-2 bg-[#31a169] text-black text-lg font-semibold rounded-xl cursor-pointer hover:bg-[#0f766e]">
              Sign Up
            </button>
          </form>
