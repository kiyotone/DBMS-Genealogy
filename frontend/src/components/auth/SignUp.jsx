...
const Signup = () => {
  ...
  const navigate = useNavigate(); // ✅ useNavigate must be at the top level of the component
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-[#FDF7F2] text-black">
      <div className="w-96 p-6 bg-white shadow-lg border border-[#A78B71] rounded-lg text-center">
        ...
        <div>
          <h2 className="text-3xl font-semibold mb-6 text-[#4A4A4A]">
            Sign Up
          </h2>
          <form
          ...
          <div className="mt-4 text-sm text-gray-600">
            <p>
              ...
              <a
                href="/login"
                className="text-[#10b981] hover:text-black underline"
              >
                Login
              </a>
            </p>
